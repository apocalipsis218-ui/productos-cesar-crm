...
const checks=[
  ['versión V9.3.7.7 visible',pkg.version==='9.3.7.7'&&/V9\.3\.7\.7 PWA/.test(main)],
  ...
  ['cambio de composición regresa a Carnicería',/volverá a Carnicería para confirmar nuevamente/.test(main)],
...
console.log('Auditoría Sincronización de Pesaje tras Edición V9.3.7.7 aprobada.');
