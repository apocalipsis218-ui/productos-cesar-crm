...
ok((main.includes('V9.3.4 PWA')||main.includes('V9.3.5 PWA'))&&(pwa.includes("APP_VERSION = 'V9.3.4 PWA'")||pwa.includes("APP_VERSION = 'V9.3.5 PWA'")),'versión V9.3.4 o superior visible');
