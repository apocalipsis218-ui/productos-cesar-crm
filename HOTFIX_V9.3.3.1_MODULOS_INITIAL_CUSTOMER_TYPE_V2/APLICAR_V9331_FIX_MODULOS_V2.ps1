...
Write-Host ''
Write-Host 'Productos Cesar CRM - HOTFIX V9.3.3.1 V2' -ForegroundColor Cyan
...
$expected = "function isInternalSale(o){ return orderCustomerType(o)==='Venta interna'; }"
if (-not $main.Contains($expected)) {
...
Write-Host ''
Write-Host 'HOTFIX V9.3.3.1 V2 completado correctamente.' -ForegroundColor Green
