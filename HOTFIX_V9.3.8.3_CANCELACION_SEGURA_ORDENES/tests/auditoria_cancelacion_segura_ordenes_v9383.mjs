...
const checks=[
  ['versión V9.3.8.3 sincronizada',pkg.version==='9.3.8.3'&&main.includes('V9.3.8.3 PWA')],
  ...
  ['SQL 41 informado al usuario',main.includes('SQL 41 de V9.3.8.3')],
...
console.log('Auditoría Cancelación Segura de Órdenes V9.3.8.3 aprobada.');
