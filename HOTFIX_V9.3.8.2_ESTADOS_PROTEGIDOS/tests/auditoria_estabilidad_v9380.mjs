...
assert.match(main,/p_estado_esperado:old,p_estado_nuevo:'En preparación'/,'La toma debe ser condicional y atómica.');
...
console.log('Auditoría de estabilidad V9.3.8.2 aprobada.');
