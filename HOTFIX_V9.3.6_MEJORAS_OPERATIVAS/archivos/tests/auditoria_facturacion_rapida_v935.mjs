...
ok(['9.3.5','9.3.6'].includes(pkg.version),'package actualizado a V9.3.5');
ok((main.includes('V9.3.5 PWA')||main.includes('V9.3.5.1 PWA')||main.includes('V9.3.6 PWA'))&&(pwa.includes("APP_VERSION = 'V9.3.5 PWA'")||pwa.includes("APP_VERSION = 'V9.3.5.1 PWA'")||pwa.includes("APP_VERSION = 'V9.3.6 PWA'")),'versión V9.3.5 PWA o revisión visible');
