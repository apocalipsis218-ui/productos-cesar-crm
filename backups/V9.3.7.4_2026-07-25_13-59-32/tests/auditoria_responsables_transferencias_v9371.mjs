...
const checks=[
<<<<<<< Updated upstream
  ['marcador V9.3.7.1 visible',/V9\.3\.7\.(?:1|2|3) PWA/.test(main)&&/V9\.3\.7\.(?:1|2|3) PWA/.test(pwa)&&/V9\.3\.7\.(?:1|2|3) PWA/.test(html)],
=======
  ['marcador V9.3.7.1 visible',/V9\.3\.7\.(?:1|2) PWA/.test(main)&&/V9\.3\.7\.(?:1|2) PWA/.test(pwa)&&/V9\.3\.7\.(?:1|2) PWA/.test(html)],
>>>>>>> Stashed changes
