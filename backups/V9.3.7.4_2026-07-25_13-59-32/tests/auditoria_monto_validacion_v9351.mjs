...
ok(/^9\.3\.(?:[5-9]|[1-9]\d+)(?:\.\d+)?$/.test(pkg.version),'package base V9.3.5 con revisión V9.3.5.1 integrada');
<<<<<<< Updated upstream
ok((main.includes('V9.3.5.1 PWA')||main.includes('V9.3.6 PWA')||main.includes('V9.3.7 PWA')||main.includes('V9.3.7.1 PWA')||main.includes('V9.3.7.3 PWA'))&&(pwa.includes("APP_VERSION = 'V9.3.5.1 PWA'")||pwa.includes("APP_VERSION = 'V9.3.6 PWA'")||pwa.includes("APP_VERSION = 'V9.3.7 PWA'")||pwa.includes("APP_VERSION = 'V9.3.7.1 PWA'")||pwa.includes("APP_VERSION = 'V9.3.7.3 PWA'")),'versión V9.3.5.1 PWA visible');
=======
ok((main.includes('V9.3.5.1 PWA')||main.includes('V9.3.6 PWA')||main.includes('V9.3.7 PWA')||main.includes('V9.3.7.1 PWA')||main.includes('V9.3.7.2 PWA'))&&(pwa.includes("APP_VERSION = 'V9.3.5.1 PWA'")||pwa.includes("APP_VERSION = 'V9.3.6 PWA'")||pwa.includes("APP_VERSION = 'V9.3.7 PWA'")||pwa.includes("APP_VERSION = 'V9.3.7.1 PWA'")||pwa.includes("APP_VERSION = 'V9.3.7.2 PWA'")),'versión V9.3.5.1 PWA visible');
>>>>>>> Stashed changes
