...
const checks=[
<<<<<<< Updated upstream
  ['versión V9.3.7.2 conservada en la versión actual',/V9\.3\.7\.3 PWA/.test(main)&&/V9\.3\.7\.3 PWA/.test(pwa)&&/V9\.3\.7\.3 PWA/.test(html)&&pkg.version==='9.3.7.3'],
=======
  ['versión V9.3.7.2 visible',/V9\.3\.7\.2 PWA/.test(main)&&/V9\.3\.7\.2 PWA/.test(pwa)&&/V9\.3\.7\.2 PWA/.test(html)&&pkg.version==='9.3.7.2'],
>>>>>>> Stashed changes
