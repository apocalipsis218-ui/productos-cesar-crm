...
('Asignada a delivery','Cobrado','liquidacion'),
('Asignada a delivery','Entregado','liquidacion'),
('Asignada a delivery','Entregado a crédito','liquidacion'),
('Asignada a delivery','No entregado','liquidacion'),
('Asignada a delivery','Devuelto parcial','liquidacion'),
('En ruta','Cobrado','liquidacion'),
('En ruta','Entregado','liquidacion'),
('En ruta','Entregado a crédito','liquidacion'),
('En ruta','No entregado','liquidacion'),
('En ruta','Devuelto parcial','liquidacion'),
...
begin
  ...
  if not public.es_admin_operativo()
     ...
     and not public.tiene_algun_modulo(array['liquidacion'],'editar') then
