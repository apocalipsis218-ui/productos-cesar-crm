...
import { calculatePartialReturn, deliveredQuantity, netDeliveredWeight } from './partialReturnsV9392.js';
...
// V9.3.9.2 · Devolución parcial por artículos con monto y peso netos.
...
function openCloseBatchLiquidationModal(deliveryName,g){
  ...
  function rowCalc(o){
    ...
    if(selectedResult==='Devuelto parcial') err='Pulsa “Detallar artículos” para registrar producto, cantidad y peso.';
    let finalCredit=0;
    let returnAmount=0;
  ...
  $$('[data-batch-partial]',m).forEach(detailBtn=>detailBtn.onclick=()=>{
    ...
    m.remove();
    openLiquidacionOrdenModal(o);
    toast('Detalla los artículos devueltos. Al guardar, podrás continuar recibiendo el lote.');
  });
