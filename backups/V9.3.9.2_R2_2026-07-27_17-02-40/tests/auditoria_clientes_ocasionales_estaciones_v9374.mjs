...
const checks=[
  ['versión V9.3.9.0 o superior visible',/^9\.3\.9\.[0-9]+$/.test(pkg.version)&&main.includes(`V${pkg.version}`)],
...
console.log('Auditoría Clientes Ocasionales, Estaciones y Ordenamiento V9.3.9.0 aprobada.');
