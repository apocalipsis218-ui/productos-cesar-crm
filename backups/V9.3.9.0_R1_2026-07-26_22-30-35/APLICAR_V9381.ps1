...
$backupDir = Join-Path $projectDir "backups\V9.3.8.1_$timestamp"
$excludedNames = @('APLICAR_V9381.ps1', 'LEEME_V9.3.8.1.txt')

Write-Host ''
Write-Host 'Productos Cesar CRM - V9.3.8.1 AUDITADA' -ForegroundColor Cyan
Write-Host 'Guardado transaccional de ordenes y preparacion'
Write-Host ''
...
Write-Host ''
Write-Host 'V9.3.8.1 aplicada, auditada y compilada correctamente.' -ForegroundColor Green
Write-Host 'IMPORTANTE: ejecuta en Supabase el SQL 39 antes de probar los guardados.' -ForegroundColor Yellow
Write-Host 'supabase\sql\39_actualizacion_v9381_guardado_transaccional.sql' -ForegroundColor Cyan
