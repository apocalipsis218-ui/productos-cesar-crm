...
const checks=[
  ['marcador V9.3.7.1 o superior visible',/V9\.3\.(?:7\.(?:1|2|3|4|5|6|7|8|9)|8\.0) PWA/.test(main)&&/V9\.3\.(?:7\.(?:1|2|3|4|5|6|7|8|9)|8\.0) PWA/.test(pwa)&&/V9\.3\.(?:7\.(?:1|2|3|4|5|6|7|8|9)|8\.0) PWA/.test(html)],
