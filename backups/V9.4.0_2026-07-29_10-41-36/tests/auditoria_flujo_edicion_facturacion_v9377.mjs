...
const checks=[
  ['versión V9.3.9.0 o superior',/^9\.3\.9\.[0-9]+$/.test(pkg.version)&&main.includes(`V${pkg.version} PWA`)],
...
console.log('Auditoría Flujo de Edición desde Facturación V9.3.9.0 aprobada.');
