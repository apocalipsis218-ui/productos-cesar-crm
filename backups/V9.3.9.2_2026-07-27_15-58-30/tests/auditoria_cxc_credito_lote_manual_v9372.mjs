...
const checks=[
  ['versión V9.3.7.2 conservada en la versión actual',/^9\.3\.9\.[0-9]+$/.test(pkg.version)&&main.includes(`V${pkg.version} PWA`)&&pwa.includes(`V${pkg.version} PWA`)&&html.includes(`V${pkg.version} PWA`)],
