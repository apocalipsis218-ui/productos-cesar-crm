...
const checks=[
  ['versión V9.3.7.3 o superior sincronizada',/^9\.3\.9\.[0-9]+$/.test(pkg.version)&&main.includes(`V${pkg.version}`)&&pwa.includes(`APP_VERSION = 'V${pkg.version} PWA'`)&&html.includes(`V${pkg.version} PWA`)],
