...
ok(['9.3.1','9.3.2','9.3.3','9.3.4','9.3.5','9.3.6'].includes(pkg.version),'package conserva la PWA desde V9.3.1');
...
ok(/V9\.3\.(?:[1-9]|\d{2,})(?:\.\d+)? PWA/.test(main),'versión PWA actual visible');
