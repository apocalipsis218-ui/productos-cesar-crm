...
ok((main.includes('V9.3.5.1 PWA')||main.includes('V9.3.6 PWA')||main.includes('V9.3.7 PWA')||main.includes('V9.3.7.1 PWA'))&&(pwa.includes("APP_VERSION = 'V9.3.5.1 PWA'")||pwa.includes("APP_VERSION = 'V9.3.6 PWA'")||pwa.includes("APP_VERSION = 'V9.3.7 PWA'")||pwa.includes("APP_VERSION = 'V9.3.7.1 PWA'")),'versión V9.3.5.1 PWA visible');
