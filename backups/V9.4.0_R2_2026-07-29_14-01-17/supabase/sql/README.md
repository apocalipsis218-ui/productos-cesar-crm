...
La V9.4.0 agrega el SQL 51. Debe ejecutarse una sola vez después del SQL 50.
Crea la cartera formal, recibos numerados, aplicaciones por factura,
vencimientos, antigüedad y reversión administrativa auditada. También crea
una vista ligera de CXC para que los créditos históricos no formen parte de
la consulta de trabajo operativo.
