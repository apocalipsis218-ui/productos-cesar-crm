...
$backupDir = Join-Path $projectDir "backups\V9.3.8.3_$timestamp"
$excludedNames = @('APLICAR_V9383.ps1', 'LEEME_V9.3.8.3.txt')

Write-Host ''
Write-Host 'Productos Cesar CRM - V9.3.8.3 AUDITADA' -ForegroundColor Cyan
Write-Host 'Cancelacion y archivado seguro de ordenes'
Write-Host ''
...
Write-Host ''
Write-Host 'V9.3.8.3 aplicada, auditada y compilada correctamente.' -ForegroundColor Green
Write-Host 'IMPORTANTE: ejecuta en Supabase el SQL 41 antes de probar el flujo.' -ForegroundColor Yellow
Write-Host 'supabase\sql\41_actualizacion_v9383_cancelacion_segura_ordenes.sql' -ForegroundColor Cyan
