...
ok(['9.3.3','9.3.4'].includes(pkg.version),'package actualizado a V9.3.3');
ok(main.includes('V9.3.3') && ['V9.3.3 PWA','V9.3.4 PWA'].some(v=>pwa.includes(`APP_VERSION = '${v}'`)),'versión V9.3.3 PWA visible');
