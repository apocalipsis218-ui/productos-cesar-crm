...
const checks=[
  ...
  ['sobrante exige autorización dentro de la ficha',/¿Autorizas aplicar este desglose con sobrante\?/.test(main)&&/Sobrante de .* no autorizado\. El desglose permanece abierto/.test(main)],
