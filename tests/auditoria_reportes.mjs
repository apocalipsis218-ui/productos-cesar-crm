...
for(const marker of required){ if(!main.includes(marker) && !css.includes(marker)) throw new Error('Falta marcador de Reportes V9.2.13: '+marker); }
...
console.log('OK: Reportes V9.2.13 tiene filtros, comparaciones, detalle y control de calidad.');
