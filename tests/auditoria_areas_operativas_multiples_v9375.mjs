...
const checks=[
  ...
  ['cola conserva ID real del empleado',
    (/tomado_por_empleado_id:employee\?\.id/.test(main)||/p_empleado_id:employee\?\.id/.test(main))&&
    /carnQueueCountByEmployeeId/.test(main)],
