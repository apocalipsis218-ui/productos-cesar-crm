...
ok(main.includes('V9.3.3') && ['V9.3.3 PWA','V9.3.4 PWA','V9.3.5 PWA','V9.3.5.1 PWA','V9.3.6 PWA','V9.3.7 PWA','V9.3.7.1 PWA','V9.3.7.3 PWA','V9.3.7.8 PWA'].some(v=>pwa.includes(`APP_VERSION = '${v}'`)),'versión V9.3.3 PWA visible');
