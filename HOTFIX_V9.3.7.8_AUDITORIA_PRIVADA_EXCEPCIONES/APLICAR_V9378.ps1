...
$backupDir = Join-Path $projectDir "backups\V9.3.7.8_$timestamp"
$excludedNames = @('APLICAR_V9378.ps1', 'LEEME_V9.3.7.8.txt')

Write-Host ''
Write-Host 'Productos Cesar CRM - V9.3.7.8 AUDITADA' -ForegroundColor Cyan
Write-Host 'Auditoria privada y reversion segura de lotes'
Write-Host ''
...
Write-Host ''
Write-Host 'V9.3.7.8 aplicada, auditada y compilada correctamente.' -ForegroundColor Green
Write-Host 'IMPORTANTE: ejecuta en Supabase los SQL 36 y 37, en ese orden.' -ForegroundColor Yellow
