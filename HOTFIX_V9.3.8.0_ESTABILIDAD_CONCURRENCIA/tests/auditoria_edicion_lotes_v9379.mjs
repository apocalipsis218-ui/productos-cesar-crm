...
const checks=[
  ['versión V9.3.8.0 o superior sincronizada',/^9\.3\.(?:[89]|\d{2,})\./.test(pkg.version)&&new RegExp(`V${pkg.version.replaceAll('.','\\.')} PWA`).test(main)],
...
console.log('Auditoría Edición Segura de Lotes V9.3.8.0 aprobada.');
