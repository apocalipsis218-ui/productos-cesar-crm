...
$backupDir = Join-Path $projectDir "backups\V9.3.9.3_$timestamp"
$excludedNames = @('LEEME_V9.3.9.3.txt')

Write-Host 'Productos Cesar CRM - V9.3.9.3 AUDITADA' -ForegroundColor Cyan
Write-Host 'No entregados regresan a Validacion para reasignacion'
...
Write-Host ''
Write-Host 'V9.3.9.3 aplicada, auditada y compilada correctamente.' -ForegroundColor Green
Write-Host 'Ahora ejecuta el SQL 47 en Supabase antes de probar No entregado.' -ForegroundColor Yellow
