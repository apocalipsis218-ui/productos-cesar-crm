...
$backupDir = Join-Path $projectDir "backups\V9.3.9.2_R2_$timestamp"
$excludedNames = @('LEEME_V9.3.9.2_R2.txt')

Write-Host 'Productos Cesar CRM - V9.3.9.2 R2 AUDITADA' -ForegroundColor Cyan
Write-Host 'Devolucion parcial integrada al cotejo y cierre transaccional del lote'
...
Write-Host ''
Write-Host 'V9.3.9.2 R2 aplicada, auditada y compilada correctamente.' -ForegroundColor Green
Write-Host 'Ahora ejecuta el SQL 46 en Supabase antes de probar el cierre del lote.' -ForegroundColor Yellow
