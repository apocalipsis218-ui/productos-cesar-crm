...
const checks=[
  ['versión 9.3.9.2 o superior',/^9\.3\.9\.(?:[2-9]|\d{2,})$/.test(pkg.version)],
  ...
  ['batch bloquea devolución sin artículos',/Pulsa “Detallar artículos” y guarda la devolución/.test(main)],
