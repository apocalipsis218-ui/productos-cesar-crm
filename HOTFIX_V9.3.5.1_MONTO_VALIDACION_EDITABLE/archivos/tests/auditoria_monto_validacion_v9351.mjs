...
ok(pkg.version==='9.3.5','package base V9.3.5 con revisión V9.3.5.1 integrada');
ok(main.includes('V9.3.5.1 PWA')&&pwa.includes("APP_VERSION = 'V9.3.5.1 PWA'"),'versión V9.3.5.1 PWA visible');
