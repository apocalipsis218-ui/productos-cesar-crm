...
const checks=[
  ['versión V9.3.8.1 sincronizada',pkg.version==='9.3.8.1'&&main.includes('V9.3.8.1 PWA')],
  ...
  ['errores exigen SQL 39',main.includes('SQL 39 de V9.3.8.1')]
];
...
console.log('Auditoría Guardado Transaccional V9.3.8.1 aprobada.');
